        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-bold text-white">ArogyaMitra</h2>
            </div>

            <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
              ArogyaMitra helps you connect with doctors, book consultations,
              and manage your healthcare journey securely from anywhere.
            </p>
          </div>
