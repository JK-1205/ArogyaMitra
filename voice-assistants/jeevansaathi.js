...
export default function JeevanSaathi() {
  ...
  const handleStartCall = async () => {
    ...
    setLoading(true);
    try {
      const assistantId = "8c63e967-e857-461d-9093-48d0f6418d2b";
    ...
    <div className="flex gap-4">
      {!isCallActive ? (
        <button
          ...
          disabled={loading}
          className="bg-orange-600 text-white px-4 py-2 rounded shadow flex items-center gap-2 disabled:opacity-50"
        >
          {loading ? (
