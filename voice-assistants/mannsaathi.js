...
import { Brain, Phone, PhoneOff, Loader2 } from "lucide-react";

export default function MannSaathi() {
  ...
  const handleStartCall = async () => {
    ...
    setLoading(true);
    try {
      const assistantId = "6850ff33-c9f6-4a6f-90a2-5742b94a96e6";
    ...
    <div className="flex gap-4">
      {!isCallActive ? (
        <button
          ...
          disabled={loading}
          className="bg-purple-600 text-white px-4 py-2 rounded shadow flex items-center gap-2 disabled:opacity-50"
        >
          {loading ? (
